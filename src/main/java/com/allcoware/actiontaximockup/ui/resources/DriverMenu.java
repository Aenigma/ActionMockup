...
public class DriverMenu extends javax.swing.JPanel {
     ...
     */
    public DriverMenu(JFrame frame, Container container, DriverFormFactory driverForm, CabFormFactory cabForm) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Driver Number", "First Name", "Middle Name", "Last Name", "Phone Number", "Cab Number"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        container.add(new CabMenu(frame,container,driverForm,cabForm));
